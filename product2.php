                ...
                <div class="navbar-nav">
                    ...
                    <div class="dropdown">
                        <button class="btn" type="button" id="dropdownMenuButton1" data-bs-toggle="dropdown" aria-expanded="false">
                            <a class="nav-link dropdown-toggle active p-3" href="#">products</a>
                        </button>
                        <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                            <li><a class="dropdown-item active nav-link px-2" href="product1.php">product</a></li>
        ...
        <footer class="">
            <div class="row">
                <div class="col-2 px-6">
                    ...
                    <div class="dropdown">
                        <button class="btn" type="button" id="dropdownMenuButton1" data-bs-toggle="dropdown" aria-expanded="false">
                            <a class="nav-link dropdown-toggle active" href="#">products</a>
                        </button>
                        <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                            <li><a class="dropdown-item active nav-link px-2" href="product1.php">product</a></li>
                            <li><a class="dropdown-item nav-link px-2" href="product2.php">product</a></li>
